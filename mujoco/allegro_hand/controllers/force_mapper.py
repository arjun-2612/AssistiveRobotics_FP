...
class ForceMapper:
    ...
    def combine_forces(self, impedance_forces: np.ndarray, internal_forces: np.ndarray) -> np.ndarray:
        """
    ...
    def map_to_joint_torques(self, contact_forces: np.ndarray, jacobian: np.ndarray) -> np.ndarray:
        """
    ...
    def compute_full_pipeline(self, impedance_forces: np.ndarray, internal_forces: np.ndarray, jacobian: np.ndarray) -> Tuple[np.ndarray, np.ndarray]:
        """
    ...
    def decompose_torques(self, joint_torques: np.ndarray, jacobian: np.ndarray) -> np.ndarray:
        """
    ...
    @staticmethod
    def analyze_force_decomposition(impedance_forces: np.ndarray, internal_forces: np.ndarray, n_contacts: int = 4) -> dict:
        """
